...
```md
![Web Home Page](./images/evidence/web-home-page.png)

![Web Cognito](./images/evidence/web-cognito.png)

![Web Dashboard](./images/evidence/web-dashboard.png)

![Web AI Feature Success](./images/evidence/web-ai-feature-success.png)
```
...
| index.html           | SPA 진입점                 |
| assets/              | Vite 빌드 결과물             |
| Public Access Block  | 직접 공개 접근 차단             |
| CloudFront Origin 연결 | S3를 CloudFront의 원본으로 사용 |

```md
![S3 Frontend Objects](./images/evidence/s3-frontend-objects.png)
```

### 설명

React/Vite 빌드 결과물을 S3 버킷에 업로드하고, CloudFront를 통해 사용자에게 제공하도록 구성했다.
S3 버킷은 정적 파일 저장소 역할을 하며, 사용자는 CloudFront를 통해 서비스에 접근한다.
...
```md
![CloudFront Distribution](./images/evidence/cloudfront-distribution.png)
```
...
```md
![API Gateway Routes](./images/evidence/api-gateway-routes.png)
```
...
```md
![Authorization 401 Unauthorized](./images/evidence/Authorization401-Unauthorized.png)
![JWT401 Unauthorized](./images/evidence/JWT401-Unauthorized.png)
![200 OK](./images/evidence/200-OK.png)
![429 Too Many Requests](./images/evidence/429-Too-Many-Requests.png)
```
...
```md
![Correction Lambda Function Logs](./images/evidence/Correction-lambda-function-logs.png)
![Conversation Lambda Function Logs](./images/evidence/Conversation-lambda-function-logs.png)
![Level-test Lambda Function Logs](./images/evidence/Level-test-lambda-function-logs.png)
![Usage Lambda Function Logs](./images/evidence/Usage-lambda-function-logs.png)
![History Lambda Function Logs](./images/evidence/History-lambda-function-logs.png)
![Profile Lambda Function Logs](./images/evidence/Profile-lambda-function-logs.png)
```
...
```md
![DynamoDB Tables](./images/evidence/dynamodb-tables.png)
...
```md
![DynamoDB Saved Item](./images/evidence/dynamodb-saved-item1.png)
![DynamoDB Saved Item](./images/evidence/dynamodb-saved-item2.png)
```
...
```md
![Usage Limit Before Additional API Call](./images/evidence/usage-limit-before.png)

![Usage Limit After Additional API Call](./images/evidence/usage-limit-after.png)

![API Rate Limit Response](./images/evidence/429-Too-Many-Request.png)
...
```md
![CloudWatch Logs](./images/evidence/cloudwatch-logs.png)
```
...
```md
![X-Ray Trace Map](./images/evidence/xray-trace-map.png)
...
```md
![SSM Parameter Store Detail](./images/evidence/ssm-parameter-store-detail.png)
...
```md
![Lambda IAM Role Summary](./images/evidence/lambda-iam-role-summary.png)

![Lambda IAM Policy Permissions](./images/evidence/lambda-iam-policy-permissions.png)

![Lambda IAM KMS Policy](./images/evidence/lambda-iam-kms-policy.png)
