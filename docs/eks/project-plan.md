...
> 관련 문서: `docs/overview.md`, `docs/eks/architecture.md`, `docs/eks/runbook.md`, `docs/eks/troubleshooting.md`, `docs/eks/evidence.md`
...
상세 아키텍처는 `docs/eks/architecture.md`에서 관리한다.
...
## 15. CI/CD 및 GitOps 전략

### 15.1 Image Build Pipeline
...
| 25 | 문서화           | Architecture 작성                          | `architecture.md`         |
...
| `docs/eks/architecture.md`    | EKS 아키텍처, 요청 흐름, GitOps, IRSA, Monitoring 설계 |
